...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/filesaverr')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001569815531')).split()]
